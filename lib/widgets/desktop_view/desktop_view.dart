...
class DeskTopView extends StatelessWidget {
  ...
  Future<void> _launchUrl() async {
    if (!await launchUrl(Uri.parse(
        'https://codecanyon.net/item/virtualguide-your-intelligent-aipowered-flutter-companion/46854043'))) {
      throw Exception(
          'Could not launch ${Uri.parse('https://codecanyon.net/item/virtualguide-your-intelligent-aipowered-flutter-companion/46854043')}');
    }
  }
}
